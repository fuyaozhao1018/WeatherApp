    ...
    <div class="pt-4 mb-8 relative">
      ...
      >
        <p class="py-2" v-if="searchError">
          Sorry, invalid search, please try again.
        </p>
        <p
          class="py-2"
...
const previewCity = (searchResult) => {
  ...
  router.push({
    name: "cityView",
    //to remove the space before state in the url
...
const mapboxAPIKey =
  "pk.eyJ1IjoiZnV5YW96aGFvMTAxOCIsImEiOiJjbGtuazJxMjcwdGM3M2VzNDF3dXNibzgwIn0.Rv6QQEYj3tOjEiFOkEzmVw"
